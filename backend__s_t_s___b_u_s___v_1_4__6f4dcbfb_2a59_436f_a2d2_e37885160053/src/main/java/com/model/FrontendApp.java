...
@Table(name = "\"FrontendApp\"", schema =  "\"sts-v14\"")
@Data
...
@Column(name = "\"MetaTags\"")
    ...
    @CollectionTable(schema = "\"sts-v14\"", name = "\"FrontendAppMetaTags\"",joinColumns = @JoinColumn(name = "\"AppId\""))
...
@Column(name = "\"SelectedScreenIds\"")
    @ElementCollection(fetch = FetchType.LAZY)
    @CollectionTable(schema = "\"sts-v14\"", name = "\"FrontendAppSelectedScreenIds\"",joinColumns = @JoinColumn(name = "\"AppId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"FeScreenId\""), schema = "\"sts-v14\"")
